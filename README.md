...
Fai doppio clic su `avvia.bat` e apri il browser sulla pagina indicata ad es. [http://127.0.0.1:5001](http://127.0.0.1:5001) per testare l'app in locale.
...
## 🌐 4. Messa in Produzione (Deploy su Render)

Per pubblicare l'applicazione web online gratuitamente e renderla raggiungibile da chiunque tramite un link pubblico:
